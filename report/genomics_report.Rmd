...
vcf_file <- "~/Documents/genomics/data/bobby_exome_genotyped.ann.vcf"
...
# 2. Ancestry
```{r, out.height = "460px", out.width='800px', include=TRUE, fig.align="center", fig.cap=c("Ancestry_by_snv_story"), echo=FALSE}
