...
workingdir<-"~/Documents/genomics/output/21a36b0e-e5ae-11ef-9dc1-002436b6d0cf"
setwd(workingdir)
...
allele_data$AF<-ifelse(allele_data$AD>0,allele_data$AD/allele_data$DP,1)
...
high_prs_risk_table <- high_prs_risk %>% 
  ...
  dplyr::select(`Reported Trait`,Trait,`Polygenic Risk Score`,Percentile,Citation)
